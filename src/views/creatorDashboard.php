...
require_once('../controllers/creatorDashboard.php');
// Initialize session and get user_id
$creator_id = initializeSession();
...
// Get dashboard data
$stats = getCampaignStats($conn, $creator_id);
$recent_donations = getRecentDonations($conn, $creator_id);
        ...
        <div class="stats-grid">
            ...
            <div class="stat-card">
                ...
                <div class="stat-value">
                    <?php
                    $progress = 0;
                    if (!empty($stats['total_goals'])) {
                        $progress = round(($stats['total_raised'] / $stats['total_goals']) * 100);
                    }
                    echo htmlspecialchars($progress . '%', ENT_QUOTES);
                    ?>
                </div>
